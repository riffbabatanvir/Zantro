...
export default function LanguageToggle() {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-[10px] text-black/40 dark:text-white/40 leading-tight text-right">
        <span className="block">Change language</span>
        <span className="block">ভাষা পরিবর্তন করুন</span>
      </span>

      ...
      <div className="max-w-7xl mx-auto md:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-24 mb-16 md:mb-32">
          ...
          <div className="px-4 md:px-0 flex flex-col justify-center">
            ...
            {/* Features */}
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-100 dark:border-neutral-800">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">1 Year Warranty</span>
              </div>
              <div className="flex flex-col items-center text-center gap-2">
                <div className="w-10 h-10 bg-purple-50 text-purple-600 rounded-full flex items-center justify-center">
                  <RotateCcw size={20} />
                </div>
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">30 Days Return</span>
              </div>
            </div>
          </div>
        </div>
